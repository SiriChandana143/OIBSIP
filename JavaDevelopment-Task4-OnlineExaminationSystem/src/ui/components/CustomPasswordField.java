...
/** Password field with placeholder text and proper focus border. */
public class CustomPasswordField extends JPasswordField {

    private final String placeholder;

    public CustomPasswordField(String placeholder, int cols) {
        super(cols);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (getPassword().length == 0 && placeholder != null) {
            ...
            // Use plain font for placeholder (not bullet font)
            g2.setFont(UIUtils.FONT_INPUT);
